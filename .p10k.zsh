# Generated by Powerlevel10k configuration wizard on 2022-07-19 at 20:58 IST.
...
() {
  ...
  # custom promt segemnt to display rails version defined in the file .zshrc
  POWERLEVEL9K_CUSTOM_RAILS_VERSION="zsh_rails_version"
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    rspec_stats             # Ratio of test classes versus code classes for RSpec
    custom_rails_version    # to display rails version
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR="#21971d"
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND="#fffb40"
  # Custom icon.
  ...
  #######################[ rvm: ruby version from rvm (https://rvm.io) ]########################
  # Rvm color.
  typeset -g POWERLEVEL9K_RVM_FOREGROUND="#f20000"
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND="#c934bd"
